#!/usr/bin/env bash
#SBATCH --job-name=idm-train-lora-5fps
#SBATCH --nodes=1
...
DATA_DIR=/fast/project/HFMI_SynergyUnit/p-doom/idm/train/data/data_sparse_960x540_5fps_w25
...
torchrun \
    ...
    --wandb-project idm \
    --wandb-run-name "train-lora-5fps-lr5e6-${SLURM_JOB_ID}" \
    --wandb-mode online \
    --seed 42
