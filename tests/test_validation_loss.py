...
def test_build_val_wandb_log_d_uses_fresh_val_action_split(monkeypatch):
    ...
    log_d = _TRAIN_MOD._build_val_wandb_log_d(
        ...
        val_precision_strict_f=0.6,
        val_recall_strict_f=0.7,
        val_f1_strict_f=0.6461538461538462,
        val_precision_tolerant_f=0.75,
        val_recall_tolerant_f=0.8,
        val_f1_tolerant_f=0.7741935483870968,
...
def test_build_val_wandb_log_d_skips_confusion_chart_when_no_counts(monkeypatch):
    ...
    log_d = _TRAIN_MOD._build_val_wandb_log_d(
        ...
        val_action_f1_f=0.0,
        val_precision_strict_f=0.0,
        val_recall_strict_f=0.0,
        val_f1_strict_f=0.0,
        val_precision_tolerant_f=0.0,
        val_recall_tolerant_f=0.0,
        val_f1_tolerant_f=0.0,
